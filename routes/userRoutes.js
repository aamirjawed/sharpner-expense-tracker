...
const { sendLoginHTML, sendSignupHTML, userSignup, userLogin, myProfile, premiumOrNot, forgotPasswordPage, forgotPassword, resetPasswordPage, resetPassword } = require('../controller/userController');
